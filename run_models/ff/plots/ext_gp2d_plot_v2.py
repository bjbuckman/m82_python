...
num_graph_start = np.array([10, 16])
num_graph_galdef = np.array([1, 5])
...
new_val = np.array([[1.        , 0.        , 0.        , 0.        , 0.        ],
       [0.05455595, 0.03359818, 0.02069138, 0.01274275, 0.0078476 ]])
...
fermi_data = np.loadtxt('../../../m82_data/integrated_gamma/m82_fermi.dat').T
verit_data = np.loadtxt('../../../m82_data/integrated_gamma/m82_veritas.dat').T
verit_upper = np.loadtxt('../../../m82_data/integrated_gamma/m82_veritas_upper.dat')
#verit_data[0] *= 1000
...
radio_data = np.loadtxt('../../../m82_data/integrated_radio/radio_m82.dat')
...
## 92cm
L92cm_N = np.loadtxt('../../../m82_data/92cm/92cm_N.dat').T
L92cm_S = np.loadtxt('../../../m82_data/92cm/92cm_S.dat').T
...
## 92cm OFFSET
L92cm_NW = np.loadtxt('../../../m82_data/92cm/92cm_NW.dat').T
L92cm_SW = np.loadtxt('../../../m82_data/92cm/92cm_SW.dat').T
L92cm_NE = np.loadtxt('../../../m82_data/92cm/92cm_NE.dat').T
L92cm_SE = np.loadtxt('../../../m82_data/92cm/92cm_SE.dat').T
...
## 22cm
L22cm_N = np.loadtxt('../../../m82_data/22cm/22cm_N.dat').T
L22cm_S = np.loadtxt('../../../m82_data/22cm/22cm_S.dat').T
...
## 22cm OFFSET
L22cm_NW = np.loadtxt('../../../m82_data/22cm/22cm_NW.dat').T
L22cm_SW = np.loadtxt('../../../m82_data/22cm/22cm_SW.dat').T
L22cm_NE = np.loadtxt('../../../m82_data/22cm/22cm_NE.dat').T
L22cm_SE = np.loadtxt('../../../m82_data/22cm/22cm_SE.dat').T
...
## 6cm
L6cm_N = np.loadtxt('../../../m82_data/6cm/6cm_N.dat').T
L6cm_S = np.loadtxt('../../../m82_data/6cm/6cm_S.dat').T
...
## 3cm
L3cm_N = np.loadtxt('../../../m82_data/3cm/3cm_N.dat').T
L3cm_S = np.loadtxt('../../../m82_data/3cm/3cm_S.dat').T
...
## FREE-FREE
free_free_dir = '../../../1712/bv/plots/ff_fit/m82_16bhf101312/m82_16bhf101312'
free_free_file = '../../../1712/bv/plots/ff_fit/m82_16bhf101312/m82_16bhf101312freefree_flux.dat'
...
for n in range(0,num_graph_galdef_tot):
	...
	#load data
	zS = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_z_freef.dat')
	specS = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_z0_nu_freef.dat')
	specS*=FACTOR[n]
	
	zL = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_z_synch.dat')
	specL = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_z0_nu_synch.dat')
	specL*=FACTOR[n]
	
	zS_o = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_z_freef.dat')
	specS_o = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_zoff_nu_freef.dat')
	specS_o*=FACTOR[n]
	
	zL_o = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_z_synch.dat')
	specL_o = np.loadtxt(dir_in+galdef_name[n]+'/'+galdef_name[n]+'_zoff_nu_synch.dat')
	specL_o*=FACTOR[n]
...
if plot_gamma_radio == 1:
	...
	for n in range(0,num_graph_galdef_tot):
		...
		# ax2.loglog(freef_na[0], freef_na[1]*FACTOR[n]*1e23*NFC, label=None, c=color, linestyle=':')
		# ax2.loglog(synchS[0], synchS[1]*FACTOR[n]*1e23, label=None, c=color, linestyle=':')
		ax.loglog(synch[0], synch[1], label=None, c=color, linestyle='--')
		# ax2.loglog(freefS[0], freefS[1]*FACTOR[n]*1e23, label=None, c=color, linestyle=':')
		ax.loglog(freef[0], freef[1], label=None, c=color, linestyle='-.')
		# ax2.loglog(synch[0], synch[1]*FACTOR[n]*1e23, label=r''+LABEL, c=color)
