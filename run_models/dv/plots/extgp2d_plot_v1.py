...
for n in range(0,num_graph_galdef_tot):
	...
	if SL_SCALE == 1:
		...
		freef_new = synch
		freef_new[1] = np.interp(synch[0],freef[0],freef[1])
		freef = freef_new
		
		freef_new = synch
		freef_new[1] = np.interp(synch[0],freefL[0],freefL[1])
		freefL = freef_new
	...
	if SL_SCALE == 1:
		...
		specS_o_fun = interpolate.interp1d(zS_o,specS_o,axis=1)
		specS_o = specS_o_fun(zL_o)
		zS_o = zL_o
		
		specS_fun = interpolate.interp1d(zS,specS,axis=1)
		specS = specS_fun(zL)
		zS = zL
