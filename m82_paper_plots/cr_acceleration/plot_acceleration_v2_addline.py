...
ax.plot(z, abs(grav_accel), c=cmap(0), label='m82_grav', linestyle='-', linewidth=LWIDTH, alpha=1.0)
# ax.plot(z, abs(isrf_accel), c=cmap(0), label='isrf', linestyle='--', linewidth=LWIDTH, alpha=ALPHA)
...
for n in range(0,num_graph):
	...
	ax.fill_between(z, protons_accel, protons_accel_1, facecolor=color, edgecolor=color, alpha=1., linewidth=LWIDTH*2.)
