...
if MODEE == 0:
	...
	ax.text(0.95,0.1,r'1 KeV', ha='right', va='top', color='w', transform=ax.transAxes, bbox=dict(facecolor='black', edgecolor='none', alpha=0.5, pad=2))
	EN = '1KeV'
...
if MODE == 0:
	...
	ax.text(0.05,0.9,'Model B', ha='left', va='bottom', color='w', transform=ax.transAxes, bbox=dict(facecolor='black', edgecolor='none', alpha=0.5, pad=2))
