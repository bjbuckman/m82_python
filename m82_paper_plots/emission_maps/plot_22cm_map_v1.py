...
data_file = '/mnt/c/Users/psyko/Physics/proj_gal/m82_data/22.fits'
...
ax.tick_params(which='major',width=0.5, length=8, labelsize='small', direction='in', color='white')
ax.tick_params(which='minor',width=0.25, length=5, direction='in', color='white')
...
# ax.plot(R22_01[0], R22_01[1], color=cmap(NN[0]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_02[0], R22_02[1], color=cmap(NN[1]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_03[0], R22_03[1], color=cmap(NN[2]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_04[0], R22_04[1], color=cmap(NN[3]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_05[0], R22_05[1], color=cmap(NN[4]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_06[0], R22_06[1], color=cmap(NN[5]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_07[0], R22_07[1], color=cmap(NN[6]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_08[0], R22_08[1], color=cmap(NN[7]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_09[0], R22_09[1], color=cmap(NN[8]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_10[0], R22_10[1], color=cmap(NN[9]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_11[0], R22_11[1], color=cmap(NN[10]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_12[0], R22_12[1], color=cmap(NN[11]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_13[0], R22_13[1], color=cmap(NN[12]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_14[0], R22_14[1], color=cmap(NN[13]), linewidth=WIDTH, alpha=ALPHA)
# ax.plot(R22_15[0], R22_15[1], color=cmap(NN[14]), linewidth=WIDTH, alpha=ALPHA)
...
ax.text(0.95,0.1,r'22 cm', ha='right', va='top', color='w', transform=ax.transAxes)
if MODE == 0:
	ax.text(0.05,0.9,'Model A', ha='left', va='bottom', color='w', transform=ax.transAxes)
	plot_name = 'm82_22cm_map_A'
elif MODE == 1:
	ax.text(0.05,0.9,'Model B', ha='left', va='bottom', color='w', transform=ax.transAxes)
	plot_name = 'm82_22cm_map_B'
elif MODE == 2:
	ax.text(0.05,0.9,"Model B'", ha='left', va='bottom', color='w', transform=ax.transAxes)
	plot_name = 'm82_22cm_map_Bp'

#beam
from matplotlib.patches import Ellipse
beam = Ellipse(xy=[120,-120] , width=12.7, height=11.8)
beam_plot = ax.add_artist(beam)
beam.set_facecolor('white')
beam.set_alpha(0.6)
beam.set_zorder(90)

# plot_name = 'm82_22cm_map_'
