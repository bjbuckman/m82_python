...
# data_dir = '/mnt/c/Users/psyko/Physics/proj_gal/m82_data/92cm/contour/92cm_' 
...
# R_flux = 2**np.linspace(0,11,12)*1.8e-3
# R_flux = R_flux[::-1]
# print R_flux
...
# print np.amax(gp1)*(xdel*ydel/Sr2sqArcSec)
# print np.sum(gp1)*(xdel*ydel/Sr2sqArcSec)
...
data_file = '/mnt/c/Users/psyko/Physics/proj_gal/m82_data/92.fits'
...
ax.text(0.95,0.1,r'92 cm', ha='right', va='top', color='w', transform=ax.transAxes)
if MODE == 0:
	ax.text(0.05,0.9,'Model A', ha='left', va='bottom', color='w', transform=ax.transAxes)
	plot_name = 'm82_92cm_map_A'
elif MODE == 1:
	ax.text(0.05,0.9,'Model B', ha='left', va='bottom', color='w', transform=ax.transAxes)
	plot_name = 'm82_92cm_map_B'
elif MODE == 2:
	ax.text(0.05,0.9,"Model B'", ha='left', va='bottom', color='w', transform=ax.transAxes)
	plot_name = 'm82_92cm_map_Bp'
	

#beam
from matplotlib.patches import Ellipse
beam = Ellipse(xy=[120,-120] , width=43.1, height=39.6)
ax.add_artist(beam)
beam.set_facecolor('white')
beam.set_alpha(0.6)
beam.set_zorder(90)

# plot_name = 'm82_92cm_map_'
